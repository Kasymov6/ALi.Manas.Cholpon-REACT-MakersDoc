...
function DomDis(props) {
  ...
  // Terrain stuff.
  var background = document.querySelector("#bgCanvas"),
    ...
    <div>
      <div className="scrool">
        ...
        <div className="button">
          <a href="./Documentation.html">Перейти к документации</a>
        </div>
      </div>
      <div className="info">
        <button onClick={handleClickPlus} className="add_theme">
          + Добавить Тему
        </button>
